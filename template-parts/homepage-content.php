...
<div class="container p-2 mt-lg-4 p-lg-0 main-container">
    ...
    <div class="row my-4 section">
        <div class="col-12 col-lg-6 my-lg-auto">
            <div class="row text-center text-lg-start">
                <h1><b>Natuurwandelingen</b></h1>
            </div>
            <div class="row text-center text-lg-start">
                <h1><b>In Groningen en Drenthe</b></h1>
            </div>
        ...
        <div class="col-8 col-lg-6 p-4 p-lg-0 align-items-end justify-content-center justify-content-lg-end">
            <div class="row text-center justify-content-end align-items-center">
                <img class="homepage-image float-start float-lg-end" src="<?php echo get_template_directory_uri(); ?>/images/logo.png" alt="logo">
            </div>
        </div>
    </div>
    <div class="row buffer-row"></div>
    <div class="row my-4 my-lg-4 text-center section">
        <div class="col-12 col-lg-6 d-none d-lg-block align-items-end justify-content-end">
            <div class="row my-4 my-lg-0 text-center">
                <img class="homepage-image float-start image-fit" src="<?php echo get_template_directory_uri(); ?>/images/Jet-smaller.jpg" alt="jet">
            </div>
        </div>
        <div class="col-12 col-lg-6 my-lg-auto">
    ...
    <div class="row my-4 section">
        ...
        <div class="col-8 col-lg-6 d-none d-lg-block p-4 p-lg-0 align-items-end justify-content-center justify-content-lg-end">
            <div class="row text-center justify-content-end align-items-center">
                <img class="homepage-image float-start float-lg-end image-fit" src="<?php echo get_template_directory_uri(); ?>/images/paraplu.jpg" alt="paraplu">
            </div>
        </div>
    </div>
        ...
        <div class="row text-center px-2 px-lg-0 justify-content-center">
            <div class="col-12 col-lg-8 my-2">
                <div class="row d-block d-lg-none">
                    <img class="homepage-image float-end float-lg-none image-fit" src="<?php echo get_template_directory_uri(); ?>/images/bloemen.jpg" alt="bloemen">
                </div>
                <div class="row d-none d-lg-block">
                    <img class="homepage-image d-block d-lg-none float-end float-lg-none image-fit" src="<?php echo get_template_directory_uri(); ?>/images/jet-bench.jpg" alt="bloemen">
                    <img class="homepage-image-long d-none d-lg-block float-end float-lg-none image-fit" src="<?php echo get_template_directory_uri(); ?>/images/jet-bench.jpg" alt="bloemen">
                </div>
            ...
            <div class="col-12 col-lg-4 my-2 mb-4">
                <div class="row">
                    <div class="col-6 col-lg-12 p-lg-0">
                        <img class="homepage-image d-block d-lg-none float-start image-fit" src="<?php echo get_template_directory_uri(); ?>/images/regen.jpg" alt="regen">
                        <img class="homepage-image-long-right d-none d-lg-block float-end image-fit" src="<?php echo get_template_directory_uri(); ?>/images/regen.jpg" alt="regen">
                    </div>
                    <div class="col-6 col-lg-12 d-block d-lg-none">
                        <img class="homepage-image float-start image-fit" src="<?php echo get_template_directory_uri(); ?>/images/paraplu.jpg" alt="paraplu">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row my-4 my-lg-4 text-center section">
        <div class="col-12 col-lg-6 d-none d-lg-block align-items-end justify-content-end">
            <div class="row my-4 my-lg-0 text-center">
                <img class="homepage-image float-start image-fit" src="<?php echo get_template_directory_uri(); ?>/images/jet-bloemetjes.jpg" alt="jet-bloemen">
            </div>
        </div>
