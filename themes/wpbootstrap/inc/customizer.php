...
function wpb_customize_register($wp_customize){
    ...
    $wp_customize->add_setting('showcase_text', array(
        'default'=> _x('Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aperiam asperiores corporis cumque cupiditate deleniti dicta dolor doloremque, dolores iure nemo nulla officia officiis omnis optio pariatur perspiciatis quas quibusdam temporibus unde veritatis vitae voluptatibus.', 'wpbootstrap'),
        'type'=> 'theme_mod'
    ));
